 ...
 */
import { FileInfoModel } from "@api/models/file-info-model";
 ...
 * DTO - запись
 */
export interface InstructionListItemModel {
    /**
    ...
    languageId: number;
    /**
     * Идентификатор направления (модуль - SubjectArea.Direction)
     */
    directionId: number;
    /**
    ...
    cover?: ImageInfoModel;

    content?: FileInfoModel;
}
