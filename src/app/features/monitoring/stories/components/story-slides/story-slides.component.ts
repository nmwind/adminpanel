import { DOCUMENT, isPlatformBrowser, NgClass, NgForOf, NgIf, NgStyle, NgTemplateOutlet } from '@angular/common';
import {
    AfterContentInit,
    booleanAttribute,
...
import { CarouselPageEvent, CarouselResponsiveOptions } from './story-slides.interfaces';
...
@Component({
    ...
    templateUrl: './story-slides.component.html',
    styleUrl: './story-slides.component.scss',
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
})
export class StorySlidesComponent implements AfterContentInit, OnChanges {
    /**
    ...
    ngAfterContentChecked() {
        if (isPlatformBrowser(this.platformId)) {
            ...
            if (this.value && this.itemsContainer && (
    ...
    bindDocumentListeners() {
        if (isPlatformBrowser(this.platformId)) {
            if (!this.documentResizeListener) {
                this.documentResizeListener = this.renderer.listen(this.window, 'resize', (_) => {
                    this.calculatePosition();
                });
            }
        }
